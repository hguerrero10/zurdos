...
class FirmaSeguridadWidget extends StatefulWidget {
  const FirmaSeguridadWidget({ Key? key }) : super(key: key);

  @override
  State<FirmaSeguridadWidget> createState() => _FirmaSeguridadWidgetState();
}

class _FirmaSeguridadWidgetState extends State<FirmaSeguridadWidget> {
