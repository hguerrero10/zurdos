...
class SelectForm extends StatefulWidget {
  ...
  const SelectForm({Key? key, required this.userRepository,  required this.user }) : super(key: key);
  ...
  Widget _cuadricula1() {
    return Padding(
      ...
      child: Row(
        ...
        children: [
          _boton(const Color(0xfb234798), Icons.checklist_sharp, () => Navigator.pushNamed(context, 'salida'), 'SALIDA\n C-TPAT'),
          _boton(const Color(0xfb234798), Icons.checklist_rtl_outlined, () => Navigator.pushNamed(context, 'entrada'), 'ENTRADA\n C-TPAT'),
        ],
      ),
    );
  }
